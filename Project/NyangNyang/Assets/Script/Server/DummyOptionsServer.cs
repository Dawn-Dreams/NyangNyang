...
public class DummyOptionsServer
{
    ...
    {
        new RankingData(1,1, "고양이유저1", 311000),
        new RankingData(2,2, "고양이유저2", 221000),
        new RankingData(3,3, "고양이유저3", 111000),
        new RankingData(4,4, "고양이유저1", 31000),
        new RankingData(5, 5, "고양이유저2", 3950)
    };
