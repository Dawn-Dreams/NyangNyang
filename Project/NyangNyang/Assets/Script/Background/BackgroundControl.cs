...
{
    [Header("BackgroundNum 0 -> 7")]
    public int backgroundNum;
    public Sprite[] Layer_Sprites;
    private GameObject[] Layer_Object;
    private int max_backgroundNum = 7;
    void Start()
    {
        Layer_Object = new GameObject[6];
    ...
    void ChangeSprite(){
        ...
        for (int i = 1; i < Layer_Object.Length; i++){
            ...
            //Change "Layer_(*)x" sprites in children of Layer_1->6
